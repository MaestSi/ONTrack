...
mv $WORKING_DIR"/"$SAMPLE_NAME"_top_Blast_hits.txt" $WORKING_DIR"/"$SAMPLE_NAME"_Blast_taxa_counts.txt" $WORKING_DIR"/"$SAMPLE_NAME"_Blast_species_counts.txt" $WORKING_DIR"/"$SAMPLE_NAME"_detected_species.txt" $LOGS_DIR
